export function Config(
    ...
    return {
        ...
        rateLimitPerSecond: Math.ceil(envNumber("MEDIA_SHARE__RateLimitPerSecond", 10 * clusters) / clusters),
        rateLimitBurstFactor: envNumber("MEDIA_SHARE__RateLimitBurstFactor", 100),
